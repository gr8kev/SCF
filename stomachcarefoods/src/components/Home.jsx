...
import Sales from "./assets/images/sale-shape-red.png";
...
import Delivery from "./assets/images/delivery-banner-bg.png";
...
const Home = () => {
    ...
    const handleScroll = () => {
      ...
      if (deliveryBoyTopPos < 500 && deliveryBoyTopPos > -250) {
        ...
        if (lastScrollPos < activeScrollPos) {
          setDeliveryBoyMove((prev) => prev + 1);
        } else {
          setDeliveryBoyMove((prev) => prev - 1);
        }
  ...
  const slides = [
    ...
    {
      imgSrc: Food2,
      description: "Fried Rice with Asun",
    },
    {
      imgSrc: Food3,
      description: "Garnished Fried Rice",
    },
    {
      imgSrc: Food4,
      description: "Spiced Chicken",
    },
    {
      imgSrc: heroBanner,
    ...
    <>
            ...
            >
              <div className="container">
                <div className="hero-content">
                  <p className="hero-subtitle">Eat Sleep And Feel Alright</p>
                  <h2 className="h1 hero-title">
                    Super delicious Food in town!
                  </h2>
                  <p className="hero-text">
                    Enjoy the convenience of gourmet, diet-specific food
                    delivered right to your door, making healthy eating simple
                    and satisfying
                  </p>

                  <button className="btn">
                    <a href="tel:+12265520043">Order Now</a>
                  </button>
                </div>
          ...
          <ul className="promo-list has-scrollbar">
            <li className="promo-item">
              <div className="promo-card">
                ...
                <h3 className="h3 card-title">Chinese Rice</h3>

                <p className="card-text">
                  high-quality meals crafted from the finest ingredients to
                  support your health and delight your taste buds.
                </p>
            ...
            <li className="promo-item">
              <div className="promo-card">
                ...
                <h3 className="h3 card-title">Leafy Rice</h3>

                <p className="card-text">
                  Indulge in the wholesome and flavorful meals from
                  StomachCareFoods
                </p>
            ...
            <li className="promo-item">
              <div className="promo-card">
                ...
                <p className="card-text">
                  each meal is a masterpiece of flavor and nutrition, we believe
                  that good food is the cornerstone of good health.
                </p>
            ...
            <li className="promo-item">
              <div className="promo-card">
                ...
                <h3 className="h3 card-title">Burger King</h3>

                <p className="card-text">
                  "Experience the difference with StomachCareFoods, where food
                  isn't just sustenance – it's a celebration of flavor and
                  vitality.
                </p>
            ...
            <li className="promo-item">
              <div className="promo-card">
                ...
                <p className="card-text">
                  StomachCareFoods brings the joy back to eating with our
                  delectable selection of meals designed to nourish your body
                  and soul.
                </p>
        ...
        <div className="container">
          ...
          <div className="about-content">
            <h2 className="h2 section-title">
              Intercontinental Dishes, African Dishes, and Best Meal
              <br />
              <span className="span"> in Town!</span>
            </h2>

            <p className="section-text">
              At SafeCareFoods, we value our customers above all else. We are
              committed to providing you with exceptional service and products
              that exceed your expectations. Whether you have dietary
              restrictions, preferences, or special requests, our dedicated team
              is here to help
            </p>

            <ul className="about-list">
              <li className="about-item">
                <IonIcon className="ion" name="checkmark-outline"></IonIcon>
            ...
            <button className="btn btn-hover">
              <a href="tel:+12265520043"></a> Order Now
            </button>
          </div>
        </div>
      </section>
      ...
      <section className="section food-menu" id="food-menu">
        <div className="container">
          ...
          <p className="section-text">
            Savor the goodness of StomachCareFoods. StomachCareFoods brings the
            joy back to eating with our delectable selection of meals
          </p>
          ...
          <ul className="fiter-list">
            ...
            <li>
              <button className="filter-btn">Rice</button>
            </li>

            <li>
              <button className="filter-btn">Amala</button>
            </li>
          ...
          <ul className="food-menu-list">
            <li>
              <div className="food-menu-card">
                ...
                <div className="price-wrapper">
                  ...
                  <del className="del" value="69.00"></del>
                </div>
              </div>
            </li>
            ...
            <li>
              <div className="food-menu-card">
                ...
                <div className="price-wrapper">
                  ...
                  <data className="price" value="29.00"></data>
            ...
            <li>
              <div className="food-menu-card">
                ...
                <div className="price-wrapper">
                  ...
                  <data className="price" value="49.00"></data>
            ...
            <li>
              <div className="food-menu-card">
                ...
                <h3 className="h3 card-title">Special Fried Rice</h3>

                <div className="price-wrapper">
                  <p className="price-text">Price:</p>

                  <data className="price" value="59.00 "></data>
            ...
            <li>
              <div className="food-menu-card">
                ...
                <div className="wrapper">
                  ...
                  <div className="rating-wrapper">
                    <IonIcon className="ion" name="star"></IonIcon>
                    <IonIcon className="ion" name="star"></IonIcon>
                    <IonIcon className="ion" name="star"></IonIcon>
                    <IonIcon className="ion" name="star"></IonIcon>
                    <IonIcon className="ion" name="star"></IonIcon>
                ...
                <h3 className="h3 card-title">Chips</h3>
            ...
            <li>
              <div className="food-menu-card">
                ...
                <h3 className="h3 card-title">Assorted</h3>
      ...
      <section className="section section-divider gray delivery">
        <div className="container">
          <div className="delivery-content">
            ...
            <p className="section-text">
              Our expertly coordinated logistics team works tirelessly to make
              sure your order arrives at the right time and place, preserving
              the quality and freshness of our carefully crafted meals
            </p>
            <button className="btn btn-hover">
              <a href="tel:+12265520043"></a>Order Now
            </button>
          ...
          <ul className="testi-list has-scrollbar">
            <li className="testi-item">
              <div className="testi-card">
                <div className="profile-wrapper">
                  ...
                  <div>
                    <h3 className="h4 testi-name"> William Emeka</h3>

                    <p className="testi-title"></p>
                  </div>
                </div>

                <blockquote className="testi-text">
                  "StomachCareFoods has completely transformed my eating habits.
                  The meals are incredibly delicious and nutritious. Each dish
                  is thoughtfully prepared with high-quality ingredients, and I
                  love how they cater to my specific dietary needs"
                </blockquote>
            ...
            <li className="testi-item">
              <div className="testi-card">
                <div className="profile-wrapper">
                  ...
                  <div>
                    <h3 className="h4 testi-name">Thomas Emmanuel</h3>
                ...
                <blockquote className="testi-text">
                  "I've tried many meal delivery services, but StomachCareFoods
                  stands out for the taste and quality of their food. Every meal
                  is a culinary delight, packed with flavor and made from fresh,
            ...
            <li className="testi-item">
              <div className="testi-card">
                ...
                <blockquote className="testi-text">
                  "StomachCareFoods has been a blessing for our family. The
                  meals are not only nutritious but also incredibly tasty, which
                  is a win-win for us. Our kids love the variety"
                </blockquote>
          ...
          <ul className="banner-list">
            <li className="banner-item banner-lg">
              <div className="banner-card">
                ...
                <div className="banner-item-content">
                  ...
                  <h3 className="banner-title">Events</h3>
            ...
            <li className="banner-item banner-sm">
              <div className="banner-card">
                ...
                <div className="banner-item-content">
                  <h3 className="banner-title">Decoration</h3>
            ...
            <li className="banner-item banner-sm">
              <div className="banner-card">
                ...
                <div className="banner-item-content">
                  <h3 className="banner-title">BUlK Orders</h3>
            ...
            <li className="banner-item banner-md">
              <div className="banner-card">
                ...
                <div className="banner-item-content">
                  <h3 className="banner-title">Restaurant</h3>
              ...
              <div className="blog-card">
                ...
                <div className="card-content">
                  <div className="card-meta-wrapper">
                    ...
                    <a href="#" className="card-meta-link">
                      <IonIcon className="ion" name="person-outline"></IonIcon>
